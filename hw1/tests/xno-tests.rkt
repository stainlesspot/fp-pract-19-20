...
(define (best-outcome2 board p me)
  (inexact->exact (best-outcome -inf.0 +inf.0 p board me)))

(run-tests (test-suite "best-outcome tests"
             (check-eqv? (best-outcome2 '(("X" "O" "O")
                                          ("O" "X" "X")
                                          (#f  #f  #f ))
                                        '(2 . 2)
                                        #t)
                         1)
             (check-eqv? (best-outcome2 '(("X" "O" "X")
                                          ("O" "O" "X")
                                          (#f  "X" "O"))
                                        '(2 . 0)
                                        #t)
                         0)
             (check-eqv? (best-outcome2 '(("O" "O" "O")
                                          ("O" "X" "X")
                                          (#f  #f  "X"))
                                        '(2 . 1)
                                        #t)
                         -1)
             (check-eqv? (best-outcome2 '((#f  "O" "O")
                                          ("X" "O" "X")
                                          (#f  "X" "X"))
                                        '(0 . 0)
                                        #t)
                         -1)
             (check-eqv? (best-outcome2 '(("O" "X" "X")
                                          ("X" "O" #f )
                                          (#f  #f  #f ))
                                        '(1 . 2)
                                        #f)
